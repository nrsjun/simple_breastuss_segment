...
if __name__ == "__main__":
    print("Testing Data Management Classes...")
    ...
    patient_id = dm.create_patient(patient_data)
    ...
    analysis_data = {
        "classification": {
            "prediction": "benign",
            "confidence": 0.85,
            "probabilities": {"benign": 0.90, "malignant": 0.10}
        },
        "segmentation": {
            "tumor_detected": True,
    ...
    success = dm.save_analysis(patient_id, analysis_data)
    ...
    print("\\nData management classes work correctly!")